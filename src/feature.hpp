...
public:
	static Eigen::Vector3d compute_unrotated_hc( const Eigen::Vector3d & rW, const Eigen::VectorXd & yi);
	static Eigen::Vector3d compute_cartesian( const Eigen::VectorXd & yi);
